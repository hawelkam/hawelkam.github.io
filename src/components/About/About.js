        ...
        <section className="about" id="about">
            ...
            <Row>
                <Col className="about__long-copy text-center">
                    <Fade bottom>
                        <p>My name is Michał Hawełka. I'm a frontend developer, video editor and video games journalist. My main professional focus is on the frontend position, but those other fields are equally important for me (even though I'm working in them only 'after hours').</p>
