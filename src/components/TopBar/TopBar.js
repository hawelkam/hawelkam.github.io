...
const TopBar = () => {
    return (
        <header className="bg-secondary" id="pageTop">
            <Navbar collapseOnSelect expand="lg" className="mh-navbar" variant="dark">
                ...
                <Navbar.Collapse id="responsive-navbar-nav" className="justify-content-end">
                    <Nav className="text-uppercase align-items-center">
                        <RouterLink to="/" className="nav-link m-2">Home</RouterLink>
                        <Link to="hero" className="nav-link m-2" activeClass="active" spy={true} smooth={true} offset={-70} duration={500}>About Me</Link>
